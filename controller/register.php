<?php
require_once 'db.php'; // Ensure this points correctly to your db.php
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: ../create_account.php?error=" . urlencode("Email already exists."));
        exit();
    } else {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: ../create_account.php?error=" . urlencode("Registration failed. Please try again."));
            exit();
        }
    }
